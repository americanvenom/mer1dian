...
--     --Citizen.InvokeNative(0x89F5E7ADECCCB49C, PlayerPedId(), "combat") --funciona en peds
--     --Citizen.InvokeNative(0x89F5E7ADECCCB49C, PlayerPedId(), "default") --funciona en peds
--     --Citizen.InvokeNative(0x89F5E7ADECCCB49C, PlayerPedId(), "very_drunk",0,-1) -- quitar andar
--     --Citizen.InvokeNative(0x89F5E7ADECCCB49C, PlayerPedId(), "very_drunk",true,-1) -- poner nuevo andar
-- end, false)
